...
import classes from "./EditWebCourse.module.scss";
  ...
  useEffect(() => {
    const getUserData = async () => {
      try {
        ...
        setHtml(docsRes.data.html);
        setCss(docsRes.data.css);
        setJavascript(docsRes.data.javascript);
      } catch (err) {
        console.log(err);
      }
    };
    ...
    if (courseName !== "" && courseBio !== "") {
      try {
        const res = await axios.post(
          `${process.env.REACT_APP_API_ADDRESS}editWebCourses/create`,
          {
            title: courseName,
            abstract: courseBio,
            html: html,
        ...
        navigate("/profileStructure/whichExam");
        console.log(res);
      } catch (err) {
        console.log(err);
      }
